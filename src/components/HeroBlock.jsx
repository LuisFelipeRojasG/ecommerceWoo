...
function HeroBlock() {
  return (
    <section className='col-start-1 col-end-5 grid-rows-4 md:col-span-12 md:grid md:grid-cols-12 md:grid-rows-4 pb-4'>
        <div className='md:col-span-6 md:row-span-4 md:col-start-2 grid grid-rows-4'>
            <h1 className='col-span-1 md:row-start-2 font-Roboto text-6xl text-Dark'>Collections</h1>
