...
function FeatureTop() {
  return (
    <section className='col-start-1 col-end-5 md:col-end-13'>
      <div className='grid grid-cols-4 grid-rows-5 gap-y-9 md:grid-cols-12 md:grid-rows-2 font-Roboto items-center mb-20'>
        <h2 className='row-start-1 col-span-4 md:col-span-12 md:col-start-4 md:col-end-10 text-center text-Headline_two text-Dark'>What makes our brand different</h2>
        <div className='row-start-2 col-span-4 md:col-span-3 h-60 mx-4 p-6 justify-center text-botton bg-BorderGrey'>
          <GrDeliver size={30}/>
        ...
        <div className='row-start-3 col-span-4 md:col-span-3 h-60 mx-4 p-6 justify-center md:row-start-2 text-botton bg-BorderGrey'>
        ...
        <div className='row-start-4 col-span-4 md:col-span-3 h-60 mx-4 p-6 justify-center md:row-start-2 text-botton bg-BorderGrey'>
          <FaCheck size={30} />
        ...
        <div className='row-start-5 col-span-4 md:col-span-3 h-60 mx-4 p-6 justify-center md:row-start-2 text-botton bg-BorderGrey'>
          <FaRecycle size={30}/>
