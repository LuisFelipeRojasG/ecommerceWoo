...
function FeatureDown() {
    return (
        <section className='col-start-1 col-end-5 md:col-end-13 flex flex-col md:flex-row items-center justify-center md:px-10 gap-4 mb-20'>
            <div className='w-auto h-[468px] md:w-[650px] md:h-full flex flex-col justify-center p-10 bg-DarkPrimary text-Light'>
